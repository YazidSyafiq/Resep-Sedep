...
class DetailDrink extends StatelessWidget {
  ...
  const DetailDrink({Key? key, required this.drink}) : super(key: key);
                ...
                Padding(
                  ...
                  child: Align(
                    ...
                    child: Column(
                      ...
                      children: drink.bahan.asMap().entries.map((entry) {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Align(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: drink.caraMasak.asMap().entries.map((entry) {
                          int index = entry.key + 1;
